      ...
      >
        <nav className="glass-strong flex w-full max-w-5xl items-center justify-between rounded-full px-5 py-3 shadow-glow">
          ...
          <div className="hidden items-center gap-8 text-sm text-white/70 md:flex">
            ...
            <Link id="nav-agents" href="/#agents" className="transition-colors hover:text-white">Agents</Link>
            <Link href="/demo" className="transition-colors hover:text-white font-semibold text-neon-cyan">Live Demo</Link>
